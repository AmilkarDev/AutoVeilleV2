    ...
    myPie = new Chart(ctx, {
        ...
        options: {
            ...
            legendCallback: function (chart) {
                ...
                text.push('<ul class="' + chart.id + '-legend">');
                for (var i = 0; i < chart.data.labels.length; i++) {
                    text.push('<li style="list-style-type:none;"><div class="legendValue"><span style="display:inline-block;width:1.9em;border-radius :15px;margin-right:15px;background-color:' + chart.data.datasets[0].backgroundColor[i] + '">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>');
